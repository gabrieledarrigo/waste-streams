...
export const WEEKDAYS_ERROR_MESSAGE =
  'Please specify a valid day: monday, tuesday, wednesday, thursday, friday, saturday, sunday, or a day-ordinal where ordinal specifies the nth day of the month. For example friday-2nd';
